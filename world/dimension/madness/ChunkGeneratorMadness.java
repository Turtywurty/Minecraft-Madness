...
public class ChunkGeneratorMadness implements IChunkGenerator 
{
	protected static final IBlockState AIR = Blocks.AIR.getDefaultState();
	protected static final IBlockState BEDROCK = Blocks.BEDROCK.getDefaultState();
	protected static final IBlockState MADNESS_GRASS = BlockInit.MADNESS_GRASS.getDefaultState();
	protected static final IBlockState WATER = Blocks.WATER.getDefaultState();
	protected static final IBlockState BASALT = BlockInit.BASALT_BLOCK.getDefaultState();
	protected static final IBlockState ASH = BlockInit.ASH_BLOCK.getDefaultState();
	...
	public ChunkGeneratorMadness(World world, boolean generate, long seed, ContextOverworld ctx)
    {
        this.world = world;
        ...
        this.slowsandGravelNoiseGen = ctx.getLPerlin2();
        this.netherrackExculsivityNoiseGen = ctx.getPerlin();
	...
	public void buildSurfaces(int x, int z, ChunkPrimer primer)
    {
        ...
        for (int j = 0; j < 16; ++j)
        {
            for (int k = 0; k < 16; ++k)
            {
                ...
                int i1 = -1;
                IBlockState iblockstate = MADNESS_GRASS;
                IBlockState iblockstate1 = MADNESS_GRASS;
                ...
                for (int j1 = 127; j1 >= 0; --j1)
                {
                    if (j1 < 127 - this.rand.nextInt(5) && j1 > this.rand.nextInt(5))
                    {
                        ...
                        {
                            if (iblockstate2.getBlock() == MADNESS_GRASS.getBlock())
                            {
                                if (i1 == -1)
                                {
                                    if (l <= 0)
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        {
            abyte[i] = (byte)Biome.getIdForBiome(BiomeInit.MADNESS);
        }
